...
<head>
    ...
    <style>
        ...
        .sidebar-nav {
            flex-grow: 1;
            /* Membuat area navigasi mengisi ruang yang tersisa */
            overflow-y: auto;
            /* HANYA area ini yang akan scroll jika menu panjang */
        }
        ...
        .content-wrapper {
            padding: 2rem;
            overflow-y: auto;
            /* Membuat area konten bisa di-scroll jika perlu */
            flex-grow: 1;
            /* Mengisi sisa ruang */
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav flex-grow-1">
            ...
            <div class="menu-header">Manajemen Akses</div>
            <a href="{{ route('roles.index') }}" class="{{ request()->routeIs('roles.*') ? 'active' : '' }}">
                <i class="fas fa-user-shield fa-fw nav-icon"></i>
                <span>Role</span>
            </a>
            <a href="{{ route('users.index') }}" class="{{ request()->routeIs('users.*') ? 'active' : '' }}">
                <i class="fas fa-users fa-fw nav-icon"></i>
                <span>User</span>
            </a>
        </div>
